...
export type ProductSizeColorVariant = Entity &
	Node & {
		color: ProductColor;
		/** The time the document was created */
		createdAt: Scalars["DateTime"]["output"];
...
export type ProductSizeVariant = Entity &
	Node & {
		/** The time the document was created */
		createdAt: Scalars["DateTime"]["output"];
		/** User that created this document */
...
export type ProductsGetByQueryQuery = {
	products: Array<{
		id: string;
		name: string;
		price: number;
...
export type ProductsGetCategoriesQueryVariables = Exact<{
	[key: string]: never;
}>;

export type ProductsGetCategoriesQuery = {
	categories: Array<{
		id: string;
		name: string;
		slug: string;
...
export type ProductsGetCollectionQueryVariables = Exact<{
	[key: string]: never;
}>;

export type ProductsGetCollectionQuery = {
	collections: Array<{
		id: string;
		name: string;
		slug: string;
...
export type ProductsGetRelatedListQuery = {
	products: Array<{
		id: string;
		name: string;
		price: number;
...
export const ProductsGetByCollectionSlugDocument = new TypedDocumentString(`
  ...
  images(first: 1) {
	...
	ProductsGetByCollectionSlugQuery,
...
export const ProductsGetByQueryDocument = new TypedDocumentString(`
  ...
  images(first: 1) {
	...
	ProductsGetByQueryQuery,
	ProductsGetByQueryQueryVariables
>;
export const ProductsGetCategoriesDocument = new TypedDocumentString(`
  ...
  categories {
	...
	ProductsGetCategoriesQueryVariables
>;
export const ProductsGetCollectionDocument = new TypedDocumentString(`
  ...
  collections {
	...
	ProductsGetCollectionQueryVariables
>;
...
export const ProductsGetRelatedListDocument = new TypedDocumentString(`
  ...
  products(first: 10, where: {categories_some: {name: $cat}, id_not: $id}) {
    ...
    `) as unknown as TypedDocumentString<
	ProductsGetRelatedListQuery,
	ProductsGetRelatedListQueryVariables
>;
