...
export const AnimatedButton = ({
	...
	return (
		<button type="submit"
			...
			onClick={onClick}
		>
			<span className="flex items-center justify-center before:absolute before:right-0 before:top-0 before:block before:h-[2px] before:left-0 before:translate-x-[100%] before:bg-cyan-800 before:transition-transform before:duration-300 after:absolute    after:bottom-0 after:left-0 after:h-[2px] after:w-full after:translate-x-[-100%] after:bg-cyan-800 after:transition-transform after:duration-300 group-hover:before:translate-x-0 group-hover:after:translate-x-0">
				{children}
			</span>
		</button>
	);
