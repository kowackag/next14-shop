...
The first step the application development is to create my own server.
...
## 👏 Special thanks  
Thanks to [Jakub Neander](https://www.linkedin.com/in/zaiste/) and [Michał Miszczyszyn](https://www.linkedin.com/in/mmiszczyszyn/) - [NEXTJS.MASTERS](https://www.nextjsmasters.pl/) instructors. 
